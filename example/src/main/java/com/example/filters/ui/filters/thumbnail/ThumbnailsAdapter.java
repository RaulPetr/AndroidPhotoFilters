...
public class ThumbnailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int i) {
        ...
        ThumbnailsViewHolder selectorsViewHolder = (ThumbnailsViewHolder) holder;
        selectorsViewHolder.thumbnail.setImageBitmap(thumbnailItem.image);
        selectorsViewHolder.thumbnail.setScaleType(ImageView.ScaleType.FIT_START);
        setAnimation(selectorsViewHolder.thumbnail, i);
        selectorsViewHolder.thumbnail.setOnClickListener(new View.OnClickListener() {
            @Override
